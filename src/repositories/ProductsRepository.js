...
class ProductsRepository {
	...
	async findByCode(code) {
      ...
      SELECT
		...
		PCPRODUT.MODULO, PCPRODUT.RUA, PCPRODUT.NUMERO, PCPRODUT.APTO,
		PCPRODUT.MODULOCX, PCPRODUT.RUACX, PCPRODUT.NUMEROCX, PCPRODUT.APTOCX
      FROM PCPRODUT
	...
	async findBySupplier(code) {
		...
		FROM PCPRODUT
			...
			JOIN PCFORNEC ON PCFORNEC.CODFORNEC = PCPRODUT.CODFORNEC
			LEFT JOIN PCDESCONTO ON PCDESCONTO.CODPROD = PCPRODUT.CODPROD
			WHERE PCFORNEC.CODFORNEC = :code AND PCPRODUT.REVENDA != 'N' AND PCPRODUT.OBS2 != 'FL'
